...
class ConfigDialog(QDialog):
    ...
    geogigIcon = QtGui.QIcon(os.path.dirname(__file__) + "/../../ui/resources/geogig.png")  
    ...
    def fillTree(self):
        ...
        generalItem = self._getItem(config.GENERAL, self.geogigIcon, config.generalParams)        
        self.tree.addTopLevelItem(generalItem)
        geogigConfigItems = self._getGeoGigConfigItems()        
        self.tree.addTopLevelItem(geogigConfigItems)
        self.tree.setColumnWidth(0, 400)

    def _getGeoGigConfigItems(self):
        item = QTreeWidgetItem()
        item.setText(0, "Ujo settings")        
        item.setIcon(0, self.geogigIcon)
        ...
        for paramName, paramValue in params.iteritems():                        
            subItem = TreeGeoGigSettingItem(paramName, paramValue)
    ...
    def _getItem(self, name, icon, params):
        ...
        for param in params:
            ...
            paramName = "/GeoGig/Settings/" + name + "/" + paramName 
...
class TreeGeoGigSettingItem(QTreeWidgetItem):
