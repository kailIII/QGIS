...
from geogig.ui.githubselectordialog import Ui_GitHubSelectorDialog  
from geogig.tools.githubimporter import GitHubConnectionException,\
    getGitHubRepos
...
class GitHubSelectorDialog(QDialog):
    ...
    def selectRepoFolder(self):
        folder = unicode(QFileDialog.getExistingDirectory(self, "Ujo repository folder"))        
        if folder != "":
