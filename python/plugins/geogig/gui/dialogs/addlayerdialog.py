...
from geogig.ui.addlayerdialog import Ui_GeoGigLayerDialog
...
class AddGeoGigLayerDialog(QDialog):
    ...
    def newLocalRepo(self):
        ...
        folder = unicode(QtGui.QFileDialog.getExistingDirectory(self, "GeoGig repository folder", path))
        if folder != "":
    ...
    def okPressed(self):
        ...
        hasField = exportFromGeoGigToTempFile(self.repo, geogig.HEAD, path)
        if not hasField:
