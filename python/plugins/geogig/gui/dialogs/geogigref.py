...
class RefWidget(QtGui.QWidget):
    ...
    def initGui(self):                    
        ...
        self.deleteBranchButton = QtGui.QPushButton('Delete', self)        
        self.deleteBranchButton.clicked.connect(self.deleteBranch) 
        horizontalLayout.addWidget(self.deleteBranchButton)       
        ...
        if self.branchRadio.isChecked():
            ...
            if commit.message != ref:                                
                try:
                    ...
                    raise GeoGigException("The provided reference does not exist: " + ref)
            else:
