...
class Ui_RepoSelectorDialog(object):
    ...
    def retranslateUi(self, RepoSelectorDialog):
        ...
        self.addButton.setText(_translate("RepoSelectorDialog", "Add local repository", None))
        self.newUjoRepoButton.setText(_translate("RepoSelectorDialog", "New Ujo repository", None))
